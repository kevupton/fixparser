...
const Table = require('cli-table'),
    ...
    messages = [
        {
            ...
            detail: 'BUY 100 CVS MKT DAY',
            fix: '8=FIX.4.2\x019=145\x0135=D\x0134=4\x0149=ABC_DEFG01\x0152=20090323-15:40:29\x0156=CCG\x01115=XYZ\x0111=NF 0542/03232009\x0154=1\x0138=100\x0155=CVS\x0140=1\x0159=0\x0147=A\x0160=20090323-15:40:29\x0121=1\x01207=N\x0110=139\x01',
        },
        {
        ...
        {
            description: 'Closing Offset (New Order Single)',
            detail: 'SL 1000 RRC LMT @55.36 DAY',
            fix: '8=FIX.4.2\x019=156\x0135=D\x0134=124\x0149=ABC_DEFG04\x0152=20100208-18:51:42\x0156=CCG\x01115=XYZ\x0111=NF 0015/02082010\x0154=2\x0138=1000\x0155=RRC\x0140=2\x0144=55.36\x0159=0\x011=ABC123ZYX\x0121=1\x01207=N\x0147=A\x019487=CO\x0110=050\x01',
        },
        {
            description: 'Closing Offset (Order Acknowledgement)',
            detail: '',
        ...
        {
            description: 'MatchPoint (New Order Single)',
            detail: 'SL 1000 MMM MKT DAY',
            fix: '8=FIX.4.2\x019=153\x0135=D\x0134=11\x0149=ABC_DEFG04\x0152=20091216-17:23:52\x0156=CCG\x0157=ARCA\x01115=XYZ\x01128=MP\x0111=NF 0921/12162009\x0154=2\x0138=1000\x0155=MMM\x0140=1\x0159=0\x011=ABC123ZYX\x0121=1\x01207=N\x0147=A\x0110=172\x01',
        },
        {
            description: 'MatchPoint (Order Acknowledgement)',
            detail: '',
        ...
        {
            description: 'Sub-Penny (New Order Single)',
            detail: 'BUY 1000 VOD LMT @.995 DAY',
            fix: '8=FIX.4.2\x019=147\x0135=D\x0134=215\x0149=ABC_DEFG04\x0152=20100208-19:36:45\x0156=CCG\x01115=XYZ\x0111=NF 0016/02082010\x0154=1\x0138=1000\x0155=VOD\x0140=2\x0144=.995\x0159=0\x011=ABC123ZYX\x0121=1\x01207=N\x0147=A\x0110=100\x01',
        },
        {
            description: 'Sub-Penny (Order Acknowledgement)',
            detail: '',
        ...
        },
        {
            description: 'Test 1',
            detail: '',
            fix: '8=FIX.4.2\x019=76\x0135=A\x0134=702\x0149=ABC\x0152=20100130-10:52:40.663\x0156=XYZ\x0195=4\x0196=1234\x0198=0\x01108=60\x0110=134\x01',
        },
        {
            description: 'Test 2',
            detail: '',
            fix: '8=FIX.4.2\x019=59\x0135=A\x0149=XYZ\x0156=ABC\x0134=710\x0152=20100130-10:52:36\x0198=0\x01108=60\x0110=103\x01',
        },
        {
            description: 'Test 3',
            detail: '',
            fix: '8=FIX.4.2\x019=51\x0135=0\x0134=703\x0149=ABC\x0152=20100130-10:53:40.830\x0156=XYZ\x0110=249\x01',
        },
        {
            description: 'Test 4',
            detail: '',
            fix: '8=FIX.4.2\x019=47\x0135=0\x0149=XYZ\x0156=ABC\x0134=711\x0152=20100130-10:53:36\x0110=057\x01',
        },
        {
            description: 'Test 5',
            detail: '',
    ...
    runOnceFixed = () => {
        ...
        for (i; i < iterations; i++) {
            fixParser.parse(
                '8=FIX.4.2\x019=154\x0135=6\x0149=BRKR\x0156=INVMGR\x0134=238\x0152=19980604-07:59:56\x0123=115686\x0128=N\x0155=FIA.MI\x0154=2\x0127=250000\x0144=7900.000000\x0125=H\x0110=231\x01',
            );
        }
